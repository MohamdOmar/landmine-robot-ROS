...
#include <SPI.h>
#include <Wire.h>
//LC#include <Adafruit_GFX.h>
//LC#include <Adafruit_PCD8544.h>
...
// pin 6 - LCD reset (RST)
//LCAdafruit_PCD8544 display = Adafruit_PCD8544(9, 8, 7, 5, 6);
...
//-----------------------ROS publishing  
        ...
        Point_msg.x= LnewPosition;
        Point_msg.y= RnewPosition;
...
//-------------        
  ...
  else 
  {
    ...
    //LCdisplay.setCursor(0, 40); display.print("rt: "); display.print((float) sumCount / sum, 2); display.print(" Hz");
    //LCdisplay.display();
    count = millis();
    sumCount = 0;
    sum = 0;
